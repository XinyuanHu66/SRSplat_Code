...
class DepthPredictorMultiView(nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # self.ref = ReferenceFeatureNetwork()
    ...
    def forward(
        ...
        # raw_correlation_in = self.ref(features)
        # raw_correlation_in = torch.cat((raw_correlation_in, features), dim=2)
        ...
        raw_gaussians_in = rearrange(
            raw_gaussians_in, "(v b) c h w -> b v (h w) c", v=v, b=b
        )
        ...
        return depths, densities, raw_gaussians, raw_gaussians_in